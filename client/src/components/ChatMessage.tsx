...
function generateFallbackQuickReplies(content: string): string[] {
  ...
  if (
    ...
    lowerContent.includes("emas") ||
    lowerContent.includes("xau")
  ) {
    return [
  ...
  if (
    ...
    lowerContent.includes("lot") ||
    lowerContent.includes("modal")
  ) {
    return [
  ...
  if (
    lowerContent.includes("berita") ||
    lowerContent.includes("news") ||
    lowerContent.includes("ekonomi")
  ) {
    return [
  ...
  if (
    lowerContent.includes("penipuan") ||
    lowerContent.includes("legal") ||
    lowerContent.includes("bappebti")
  ) {
    return [
...
function removeQuickRepliesFromContent(content: string): string {
  ...
  for (let i = 0; i < lines.length; i++) {
    ...
    if (
      trimmedLine.includes("Mau lanjut") ||
  ...
  const handleLinkClick = (
    ...
    if (linkText === "gwen stacy") {
      ...
      if (linkText === "obrolan bebas") {
        ...
        onQuickReply(
          "Saya ingin menganalisis gambar chart atau dokumen keuangan",
        );
        ...
        <div className="flex-1 space-y-1 sm:space-y-2 overflow-hidden min-w-0">
          <div className="flex items-center justify-between gap-2">
            <span
              className={cn(
                ...
                isUser ? "text-foreground" : "text-blue-300",
              )}
            >
          ...
          <div
            className={cn(
              ...
              "[&_table]:w-full [&_table]:border-collapse [&_table]:text-xs sm:[&_table]:text-sm [&_th]:border [&_th]:border-border [&_th]:p-1.5 sm:[&_th]:p-2 [&_th]:bg-muted [&_td]:border [&_td]:border-border [&_td]:p-1.5 sm:[&_td]:p-2",
